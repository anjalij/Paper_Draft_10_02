function [ glycans ] = Compartmentalization2( Trials,ResidenceTime, ENZ,inputSub,tip )
%UCompartmentalization2 is different because it has an inputSub and a tip
...
for i=1:Trials
    ...
    [GlycanSim{1},Ends{1},Times(1),NoReactions(1)]=OneCompartmentSim(ResidenceTime,LINKAGES{1},inputSub,tip,0);
